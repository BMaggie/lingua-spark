...
const HausaLessons: React.FC<LessonsProps> = ({ languages }) => {
  return (
    <div className="max-w-2xl mx-auto mt-8">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl text-blue-700">Hausa Lessons</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <ul className="space-y-3">
            <li className="p-4 bg-blue-50 rounded-lg shadow-sm">Lesson 1: Greetings in Hausa</li>
